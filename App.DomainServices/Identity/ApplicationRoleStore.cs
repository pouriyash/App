...
using App.DomainServices.Interfaces.Identity;
...
{
   public class ApplicationRoleStore : RoleStore<Role, AppDbContext, int, UserRole, RoleClaim>,IApplicationRoleStore
    {
